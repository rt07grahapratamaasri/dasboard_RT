    ...
    <div class="glass-panel p-6 animate-fade-in" style="padding: 1.5rem;">
      ...
      <div class="responsive-grid" style="display: grid; gap: 1.5rem; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr));">
        ...
        <div class="glass-card" style="padding: 1.5rem; border-top: 4px solid var(--secondary-color);">
          <h3 style="margin-bottom: 1rem;">Status Database</h3>
          <p class="text-muted" style="margin-bottom: 1.5rem; font-size: 0.9rem;">
            Aplikasi saat ini sudah terhubung dan tersinkronisasi otomatis dengan <strong>Google Sheets</strong>. Semua data Anda (Warga, Kas, Iuran) tersimpan dengan aman di cloud.
          </p>
          <p class="text-muted" style="font-size: 0.9rem;">
            Anda bisa melihat atau memanipulasi data langsung melalui file Spreadsheet Anda.
          </p>
        </div>
